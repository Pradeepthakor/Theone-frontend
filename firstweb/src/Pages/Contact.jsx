...
//     try {
//       await emailjs.send(
//         'service_tfpktzp',    // Your service ID
//         'template_qvzkj1o',   // Your template ID
//         formData,
//         'tiww_O400Iz4iz37w'   // Your user ID
//       );
//       setFormData({ name: '', email: '', message: '' });
//       alert('Your message was sent successfully.');
//     } catch (error) {
          ...
          <div className="col-lg-5 col-sm-12">
            <div className="contact-content pl-lg-5 mt-5 mt-lg-0">
              ...
              <ul className="address-block list-unstyled">
                ...
                <li>
                  <i className="ti-email mr-3"></i>Email: theonecrawlingsolutions@gmail.com
                </li>
                <li>
                  <i className="ti-mobile mr-3"></i>Phone: +91 96645 08201
                </li>
